            ...
            <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-5">
                <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
                    ...
                    <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-4">
                        ...
                        <div className="pb-4 font-medium text-red-600 text-2xl sm:text-4xl sm:pb-8 ">$15.75</div>
                        <div className="bg-accentDark hover:bg-accent text-white rounded-full w-fit flex items-center gap-4 py-2 px-4 text-[14px] sm:px-4 sm:py-3 cursor-pointer">Shop Now <BsArrowRight/></div>
                    </div>
                </div>
                <div className="relative">
                    ...
                    <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-2">
                        ...
                        <div className="font-medium text-red-600 text-2xl sm:text-4xl sm:pb-8 ">$17</div>
                        <div className="bg-accent hover:bg-accentDark text-white rounded-full w-fit flex items-center gap-4 py-2 px-4 text-[14px] sm:px-4 sm:py-3 cursor-pointer">Show Now <BsArrowRight/></div>
                    </div>
                </div>
                <div className="relative">
                    ...
                    <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-2">
                        ...
                        <p className="text-gray-500 text-xl pt-4 sm:pt-8">Starting At</p>
                        <div className="pb-4 font-medium text-red-600 text-2xl sm:text-4xl sm:pb-8 ">$5</div>
                        <div className="bg-accent hover:bg-accentDark text-white rounded-full w-fit flex items-center gap-4 py-2 px-4 text-[14px] sm:px-4 sm:py-3 cursor-pointer">Show Now <BsArrowRight/></div>
                    </div>
                </div>                
            </div>
